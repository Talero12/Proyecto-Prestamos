...
<div class="full-box page-header">
    ...
    <p class="text-justify">
        ...
        Bienvenido, Ingrese la Información que desea actualizar del Prestamo 
...
<div class="container-fluid">
    ...
    ?>
            ...
            <div class="container-fluid form-neon">
                        ...
                        <table class="table table-dark table-sm">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center" >
                                    ...
                                    <td><?php echo MONEDA.$items['detalle_costo_tiempo']; ?></td>
                ...
                <form class="FormularioAjax" action="<?php echo SERVERURL; ?>ajax/prestamoAjax.php" method="POST" data-form="update" enctype="multipart/form-data" autocomplete="off" >
            ...
            <div class="modal fade" id="ModalPago" tabindex="-1" role="dialog" aria-labelledby="ModalPago" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form class="modal-content FormularioAjax" action="<?php echo SERVERURL; ?>ajax/prestamoAjax.php" method="POST" data-form="save" enctype="multipart/form-data" autocomplete="off" >
