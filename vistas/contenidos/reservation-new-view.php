	...
	<div class="container-fluid form-neon">
        <div class="container-fluid">
            ...
            <p class="text-center">
                ...
                ?>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalCliente"><i class="fas fa-user-plus"></i> &nbsp; Agregar Usuario</button>
                <?php } ?>
            ...
            <div>
                ...
                <span class="text-danger">&nbsp; <i class="fas fa-exclamation-triangle"></i> Seleccione un Usuario</span>
                <?php }else{ ?> 
      			<form class="FormularioAjax" action="<?php echo SERVERURL; ?>ajax/prestamoAjax.php" method="POST" data-form="loans" enctype="multipart/form-data" autocomplete="off" style="display: inline-block !important;">
                ...
                <table class="table table-dark table-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center" >
                            ...
                            <td>
                                <form class="FormularioAjax" action="<?php echo SERVERURL; ?>ajax/prestamoAjax.php" method="POST" data-form="loans" enctype="multipart/form-data" autocomplete="off" >
		...
		<form class="FormularioAjax" action="<?php echo SERVERURL; ?>ajax/prestamoAjax.php" method="POST" data-form="save" enctype="multipart/form-data" autocomplete="off" >
            <fieldset>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalCliente">Agregar Usuario</h5>
...
<div class="modal fade" id="ModalAgregarItem" tabindex="-1" role="dialog" aria-labelledby="ModalAgregarItem" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form class="modal-content FormularioAjax" action="<?php echo SERVERURL; ?>ajax/prestamoAjax.php" method="POST" data-form="default" enctype="multipart/form-data" autocomplete="off" >
            <div class="modal-header">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                         ...
                         <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="detalle_costo_tiempo" class="bmd-label-floating">Costo del Producto</label>
                                <input type="text" pattern="[0-9.]{1,15}" class="form-control" name="detalle_costo_tiempo" id="detalle_costo_tiempo" maxlength="15" >
                            </div> 
                        </div>
                    </div>
                </div>
