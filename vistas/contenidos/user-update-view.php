...
<div class="full-box page-header">
	...
	<p class="text-justify">
		...
		Bienvenido, desde el panel puede actualizar la información necesaria del administrador
...
<div class="container-fluid">
	...
	?>
	<form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/usuarioAjax.php" method="POST" data-form="update" enctype="multipart/form-data" autocomplete="off" >
				...
				<div class="row">
					<div class="col-12 col-md-4">
						<div class="form-group">
							<label for="usuario_dni" class="bmd-label-floating">Documento de identidad</label>
					...
					<div class="col-12 col-md-4">
						<div class="form-group">
							...
							<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" name="usuario_nombre_up" value="<?php echo $campos['usuario_nombre']; ?>" id="usuario_nombre" maxlength="35">
						</div>
					</div>
					<div class="col-12 col-md-4">
						<div class="form-group">
							<label for="usuario_apellido" class="bmd-label-floating">Apellidos</label>
							<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" name="usuario_apellido_up" value="<?php echo $campos['usuario_apellido']; ?>" id="usuario_apellido" maxlength="35">
						</div>
					</div>
					...
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control" name="usuario_direccion_up" value="<?php echo $campos['usuario_direccion']; ?>" id="usuario_direccion" maxlength="190">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<input type="text" pattern="[a-zA-Z0-9]{1,35}" class="form-control" name="usuario_usuario_up" value="<?php echo $campos['usuario_usuario']; ?>" id="usuario_usuario" maxlength="35">
						</div>
					</div>
					<div class="col-12 col-md-6">
						<div class="form-group">
							<label for="usuario_email" class="bmd-label-floating">Email</label>
							<input type="email" class="form-control" name="usuario_email_up" value="<?php echo $campos['usuario_email']; ?>" id="usuario_email" maxlength="70">
						</div>
					</div>
					<?php if($_SESSION['privilegio_spm']==1 && $campos['usuario_id']!=1){ ?>
					<div class="col-12">
						<div class="form-group">
							<span>Estado de la cuenta &nbsp; <?php if($campos['usuario_estado']=="Activa"){ echo '<span class="badge badge-info">Activa</span>'; }else{ echo '<span class="badge badge-warning">Deshabilitada</span>'; } ?></span>
