...
<div class="full-box page-header">
	...
	<p class="text-justify">
			Bienvenido, complete la siguiente información para Registar un Nuevo administrador en el sistema y luego asignile los permisos segun su privilegio
...
<div class="container-fluid">
	<ul class="full-box list-unstyled page-nav-tabs">
		<li>
			<a class="active" href="<?php echo SERVERURL; ?>user-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO ADMINISTRADOR</a>
		</li>
		<li>
		...
		<fieldset>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-12 col-md-6">
						<div class="form-group">
							<label for="usuario_usuario" class="bmd-label-floating">Nombre de Administrador</label>
