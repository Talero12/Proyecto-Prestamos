<div class="full-box page-header">
	...
	<p class="text-justify">
		...
		BIENVENIDO, complete los espacios para Registar un nuevo usuario en el sistema.
...
<div class="container-fluid">
	<ul class="full-box list-unstyled page-nav-tabs">
		<li>
			<a class="active" href="<?php echo SERVERURL; ?>client-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR USUARIO</a>
		</li>
		<li>
