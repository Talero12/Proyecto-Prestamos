<section class="full-box nav-lateral">
	...
	<div class="full-box nav-lateral-content">
		<figure class="full-box nav-lateral-avatar">
			...
			<img src="<?php echo SERVERURL; ?>vistas/assets/avatar/discovery.png" class="img-fluid" alt="Avatar">
			<figcaption class="roboto-medium text-center">
				<?php echo $_SESSION['nombre_spm']; ?> <br><small class="roboto-condensed-light"><?php echo "(".$_SESSION['usuario_spm'].")"; ?></small>
			</figcaption>
		</figure>
